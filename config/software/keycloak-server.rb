...
version "26.5.4" do
  source md5: "3af4abfb4da6988c3410db02140f0ec4"
end

version "26.5.7" do
  source md5: "8823ac964a0f962bd95ec4cbf097cdaa"
end

version "26.6.2" do
  source md5: "295ea6df55568701374206cfd8dba8b5"
end

version "26.6.3" do
  source md5: "dc15a92414b231641937456809632a31"
end

version "26.6.4" do
  source md5: "4dcaa06331010ef9fd9221b989f52084"
end
